  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.status === "complete") {
        ...
        console.log(result);
        setError("Further steps required. Please use standard Clerk component or OAuth.");
      }
    } catch (err: any) {
      console.error(err);
    ...
    <div className="auth-outer" style={{
      ...
      >
        ...
        <div className="auth-card" style={{
          ...
          <h2 style={{ fontSize: 22, fontWeight: 600, margin: "0 0 8px", textAlign: "center" }}>Welcome back</h2>
          ...
          <div style={{ textAlign: "center", marginTop: 24 }}>
            ...
            <span onClick={() => navigate('/sign-up')} style={{ fontSize: 13, color: theme.accent, cursor: "pointer", fontWeight: 600 }}>Sign up</span>
          </div>
        </div>
      </motion.div>
    </div>
